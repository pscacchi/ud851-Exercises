...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String KEY_STORE_QUERY_URL = "query";

    // TODO (2) Create a static final key to store the search's raw JSON
    private static final String KEY_STORE_SEARCH_JSON = "results";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            String queryUrl = savedInstanceState.getString(KEY_STORE_QUERY_URL);
            mUrlDisplayTextView.setText(queryUrl);

            String rawJsonSearchResults = savedInstanceState.getString(KEY_STORE_SEARCH_JSON);
